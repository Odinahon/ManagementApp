...
function App() {
  ...
  //these functions are going to be handled from the NewTask Component therefore they need to be go through the SelectedProject Component
  ...
  const selectectedProject = projectsState.projects.find(project=> project.id === projectsState.selectedProjectId);

  let content = <SelectedProject project={selectectedProject}
